...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form  method="post" action="<?=base_url()?>main_userdev/setting_biodata" enctype="multipart/form-data" id="form">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <select name="status_reg" class="form-control" id="status_reg">
                <option value="">Apakah anda mempunyai Kartu KIP-Kuliah?</option>
                
                    <option value="Hanya Daftar" <?php if (!empty($biodata)) { if ($biodata['status_registrasi']=="Hanya Daftar") { echo 'selected=selected'; }} ?>>TIDAK, Daftar Reguler</option>
                    <option value="Bidikmisi" <?php if (!empty($biodata)) { if ($biodata['status_registrasi']=="Bidikmisi") { echo 'selected=selected'; }} ?>>YA, Ada Kartu KIP-Kuliah</option>
            </select>
...
$jne3.ajax({
    type:'post',
    url:"<?php echo base_url(); ?>" + "maindev/get_jenismhs",
    data:{kipk:kipk},
    cache:false,
    beforeSend:function(){
        $jne3('#pilihan1').attr('disabled',true);
    },
    success: function(returndata){
...
$jne3.ajax({
    type:'post',
    url:"<?php echo base_url(); ?>" + "maindev/get_kelas",
...
$jne3.ajax({
    type:'post',
    url:"<?php echo base_url(); ?>" + "maindev/get_kelas_sore",
