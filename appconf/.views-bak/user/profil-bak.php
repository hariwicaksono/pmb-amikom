...
<div class="panel panel-info">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
            <label class="control-label" style="font-weight:600">Jenis Pendaftaran & Kartu KIP-Kuliah*</label><br/>
            <label class="control-label">Apakah anda Mempunyai Kartu KIP-K?</label> &nbsp;
            <input type="radio" name="status_reg" value="Hanya Daftar" <?php if (!empty($biodata)) { if ($biodata['status_registrasi']=='Hanya Daftar') { echo 'checked=checked'; }} ?> > &nbsp;TIDAK, Pendaftaran Reguler
            &nbsp;
            <input  type="radio" name="status_reg" id="status_reg" value="Bidikmisi" <?php if (!empty($biodata)) { if ($biodata['status_registrasi']=='Bidikmisi') { echo 'checked=checked'; }} ?> > &nbsp;YA, Punya KIPK

            <input id="kipk-box" type="text" name="no_kipk" class="form-control" placeholder="Nomor KIP-Kuliah, Contoh: 6012.0000.0000.0000" style="display:none;margin-top:10px" <?php if (!empty($biodata['no_kipk'])) echo 'value='.$biodata['no_kipk']; ?> >
            <span id="kipk-info" class="text-info" style="display:none;font-size:11px"><i class="fa fa-info-circle" aria-hidden="true"></i> Pastikan nomor anda telah terdaftar pada akun KIP Kuliah di website: <a href="https://kip-kuliah.kemdikbud.go.id" target="_blank">https://kip-kuliah.kemdikbud.go.id</a>. Nomor tersebut juga terdapat pada Kartu KIPK anda.</span>
            </div>
