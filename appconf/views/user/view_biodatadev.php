...
<div class="mt-2 mb-2">
    <div class="card shadow">
        ...
        <a class="nav-link <?php if ($this->uri->segment(2)=='profil') echo 'active' ?>" href="<?=base_url()?>main_userdev/profil?act=det">Formulir</a>
        </li>
    
        <li class="nav-item" id="ribbon3" >
        <a class="nav-link <?php if ($this->uri->segment(2)=='upload') echo "active";?>" <?php if (!empty($biodata)) { ?> href="<?=base_url()?>main_userdev/upload?act=det" <?php } else { ?>  onclick="alert1();" <?php }  ?>  >Upload Dokumen</a></li>
        ...
        <div class="tab-pane fade show active">
            ...
            if ($this->uri->segment(2)=='') $this->load->view('user/infodev.php');
                elseif ($this->uri->segment(2)=='profil') $this->load->view('user/profildev.php'); 
                elseif ($this->uri->segment(2)=='upload') $this->load->view('user/upload_dokumendev.php'); 
