...
*/
$contact_menu 		= 'Paket Cetho (untuk 8 orang)';
$contact_name 		= 'Andra';
$contact_email 		= 'gleenid@gmail.com';
$contact_phone 		= '085643688710'; 
$contact_address 	= 'Jl. Utama No 73, Pugeran, Maguwoharjo, Depok, Sleman'; 
$contact_subject 	= 'Reservation Griya Tawang';
$contact_message 	= 'Pesen Makanan';
...
<p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 24px;font-size: 15px;font-family: sans-serif;color: #60666d;"><strong style="font-weight: bold;">Hi, [ Griya Tawang ]</strong></p>
...
$mail->addAddress('gleenferdinand@gmail.com', 'Andra');
