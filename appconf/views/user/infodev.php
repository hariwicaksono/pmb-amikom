    ...
    <div class="card-body">
        ...
        $tgldaftar=$this->mkonversi->TglIndonesia(date('d-m-Y',strtotime($biodata['tgldaftar']))); 
		 ...
		 <?php } else { ?>
			...
			<div class="col">
				<?php if (($biodata['syarat1']=='Lengkap') and $biodata['syarat2']=='Sudah' ) { ?><!--<?php //if (($biodata['ket_lulus']=='Lulus') and $biodata['JUR_LULUS']!='' ) { ?>-->
			...
			<small>
			<ul class="pl-3">
			<li>Tombol cetak akan muncul ketika status berubah menjadi "DITERIMA". Status akan diterima setelah Anda melengkapi form pengisian yang tersedia. Silahkan cek website secara berkala untuk mengetahui perubahan status persyaratan diterima.</li>
			</ul>
			</small>
			</div>
			<?php } ?>
