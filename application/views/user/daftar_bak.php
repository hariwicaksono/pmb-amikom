...
<ul class="nav nav-tabs nav-fill">
    ...
    <li class="nav-item" id="ribbon1">
        <a class="nav-link <?php if ($_GET['act'] == 'step1') echo "active"; ?>" href="<?= base_url() ?>main_user/daftar?act=step1">Step1</a>
    </li>
    <li class="nav-item" id="ribbon2">
        <a class="nav-link <?php if ($_GET['act'] == 'step2') echo "active"; ?>" <?php if (!empty($biodata)) { ?> href="<?= base_url() ?>main_user/daftar?act=step2" <?php } else { ?> onclick="alertStep();" <?php }  ?>>Step2</a>
    </li>
    <li class="nav-item" id="ribbon3">
        <a class="nav-link <?php if ($_GET['act'] == 'step3') echo "active"; ?>" <?php if (!empty($biodata)) { ?> href="<?= base_url() ?>main_user/daftar?act=step3" <?php } else { ?> onclick="alertStep();" <?php }  ?>>Step3</a>
    </li>
    <li class="nav-item" id="ribbon4">
        <a class="nav-link <?php if ($_GET['act'] == 'step4') echo "active"; ?>" <?php if (!empty($biodata)) { ?> href="<?= base_url() ?>main_user/daftar?act=step4" <?php } else { ?> onclick="alertStep();" <?php }  ?>>Step4</a>
    </li>
    <li class="nav-item" id="ribbon5">
        <a class="nav-link <?php if ($_GET['act'] == 'step5') echo "active"; ?>" <?php if (!empty($biodata)) { ?> href="<?= base_url() ?>main_user/daftar?act=step5" <?php } else { ?> onclick="alertStep();" <?php }  ?>>Step5</a>
    </li>
</ul>
