...
<html lang="en">
    <head> 
        ...
        })(window,document,'script','dataLayer','GTM-K4TJ5JP');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K4TJ5JP"
...
<a class="navbar-brand d-block d-sm-block d-md-block d-lg-none d-xl-none mx-auto" href="<?php echo base_url()?>"><img class="img-fluid" src="<?php echo base_url('assets/main');?>/images/logo.png" alt="Universitas Amikom Purwokerto" style="width: 180px;"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0"><a class="btn btn-success btn-lg" href="<?php echo base_url('page/login');?>" style="font-size: .9rem">MASUK/DAFTAR</a></form>
    </ul>
