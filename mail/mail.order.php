...
//$contact_product 	= mysql_real_escape_string($_POST['product']); 
$contact_subject 	= 'Order Sporty Juice';
        ...
        <tbody><tr>
            ...
            <table style="border-collapse: collapse;border-spacing: 0;" align="left">
              <tbody><tr>
                <td class="logo emb-logo-padding-box" style="padding: 0;vertical-align: top;mso-line-height-rule: at-least;width: 280px;padding-top: 24px;padding-bottom: 24px;">
                  <div class="logo-left" style="font-weight: 700;font-family: Avenir,sans-serif;color: #555;font-size: 0px !important;line-height: 0 !important;" id="emb-email-header"><img style="border: 0; " src="http://sportyjuice.com/themes/sportyjuice/images/logo1.png" alt="" width="200"></div>
                </td>
              </tr>
            </tbody></table>
          </td>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;">
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: sans-serif;color: #60666d;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;" src="http://sportyjuice.com/themes/sportyjuice/images/order-bg.jpg" alt="" width="100%">
            </div>
...
<p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 24px;font-size: 15px;line-height: 24px;font-family: sans-serif;color: #60666d;">Seseorang yang bernama '.$contact_name.' telah menghubungi anda, berikut ini detail mengenai order yang dikirim oleh saudara '.$contact_name.', anda dapat mereply email ini untuk membalasnya.</p>

<p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 24px;font-size: 15px;font-family: sans-serif;color: #60666d;"><strong style="font-weight: bold;">Order</strong></p>
<table class="order_table" width="100%" style="border-collapse: collapse; font-style: normal;font-weight: 400; font-family: sans-serif; font-size: 15px; color: #60666d;">
<tbody><tr>
	<td style="background: rgba(29,29,33,0.06); text-align:center; border: 1px solid #60666d;">No</td>
	<td style="background: rgba(29,29,33,0.06); text-align:center; border: 1px solid #60666d;">Product Name</td>
	<td style="background: rgba(29,29,33,0.06); text-align:center; border: 1px solid #60666d;">Qty</td>
	<td style="background: rgba(29,29,33,0.06); text-align:center; border: 1px solid #60666d;">Price</td>
	<td style="background: rgba(29,29,33,0.06); text-align:center; border: 1px solid #60666d;">Total</td>
</tr>';
$order = od_order($_SESSION['order_code']); $i=0; 
while($row_order=mysql_fetch_assoc($order)){ $i++; 
$post_custom= ($row_order['post_custom']!='') ? ' - '.$row_order['post_custom'] : '';
$message .= '
<tr>
	<td align="center" style=" border: 1px solid #60666d;">'.$i.'</td>
	<td style=" border: 1px solid #60666d;">'.po_value('post_id',$row_order['post_id'],'post_title').$post_custom.'</td>
	<td align="center" style=" border: 1px solid #60666d;">'.$row_order['cache_qty'].'</td>
	<td align="right" style=" border: 1px solid #60666d;">'.currency(po_value('post_id',$row_order['post_id'],'post_price')).'</td>
	<td align="right" style=" border: 1px solid #60666d;">'.currency(po_value('post_id',$row_order['post_id'],'post_price')*$row_order['cache_qty']).'</td>
</tr>';
}
$message .= '
	<tr>
	<td colspan="4" align="right" style=" border: 1px solid #60666d;">Total</td>
	<td align="right" style=" border: 1px solid #60666d;">'.currency(od_order_total($_SESSION['order_code'])).'</td>
</tr>
</tbody></table>
...
$mail->Host = "mail.sportyjuice.com";
