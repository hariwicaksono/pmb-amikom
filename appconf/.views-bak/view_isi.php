						...
						<td >
							<a data-toggle="collapse" data-parent="#accordion" href="#demo<?=$no?>" style="font-size:12px;color:red;font-weight: bold;"><?=$data['nama']?></a>
  							<div id="demo<?=$no?>"  class="panel-collapse collapse">
  								...
  								<br />
  								Keterangan Lulus : <?php if ($data['ket_lulus']=='') echo '-';else echo  $data['ket_lulus'];?>
  							</div>
						</td>
...
<?php } elseif ($modul=='Prosedur_pendaftaran'){ ?>
	...
	<div class="col-sm-11"> 
		...
		<div class="alert alert-info wow animated fadeInLeft" role="alert" style="background-color: #110d56;color:#fff;">
			SYARAT PENDAFTARAN
		</div>
		<div class="well wow animated fadeInRight" style="text-align: justify;">
<ol type="1">
