            ...
            <div id="first">
                    <div class="row align-items-center mb-3">
                        <div class="col-12">
                            ...
                            <h2 class="mb-0">Pendaftaran Awal</h2>
                        </div>
                        <!--end of col-->
                    </div>
                    <!--end of row-->
                ...
                <div id="second">
                    ...
                    <div id="form-step-1">
                        ...
                        <div class="form-row form-group">
                            <div class="col-sm-6">
                                <input type="text" name="telepon" class="form-control" placeholder="No HP/WA" maxlength="15" 
                                <?php if (!empty($biodata['telepon'])) echo 'value="' . $biodata['telepon'] . '"'; else echo 'value="' . htmlspecialchars($akun['telp']) . '"'; ?> required>
                            </div>
