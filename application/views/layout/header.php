...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?= base_url(); ?>amikompurwokerto.ico" />
  <!--google fonts-->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark sticky-top gde-purple-1" style="z-index:99 !important;">
    ...
    <a class="navbar-brand d-none d-sm-none d-md-none d-lg-block d-xl-block" href="<?= base_url() ?>"><img src="<?= base_url('assets/main/images/logo.png'); ?>" alt="Universitas Amikom Purwokerto" width="180px" style="margin-left:10px;"></a>

    <a class="navbar-brand d-block d-sm-block d-md-block d-lg-none d-xl-none mx-auto" href="<?= base_url() ?>"><img class="img-fluid" src="<?= base_url('assets/main/images/logo.png'); ?>" alt="Universitas Amikom Purwokerto" style="width: 180px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form id="form_search" class="mx-1 my-auto w-100" action="<?= site_url('main/search'); ?>" method="GET">
      ...
      <?php if (!$this->session->userdata('username')) { ?>
        <ul class="navbar-nav">
          <li class="nav-item d-none d-sm-none d-md-none d-lg-block">
            <a href="<?= base_url('page/faq'); ?>" class="nav-link"><i class="fa fa-question-circle-o fa-2x" aria-hidden="true"></i></a>
          </li>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="<?= base_url('page/faq'); ?>"><i class="fa fa-question-circle-o" aria-hidden="true"></i> Frequently Asked Questions</a>
              <a class="dropdown-item" href="<?= base_url('main/logout') ?>"><i class="fa fa-sign-out"></i> Logout</a>
            </div>
          </li>
        </ul>
