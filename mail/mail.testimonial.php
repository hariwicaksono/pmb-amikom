...
$contact_subject 	= 'Sporty Juice Testimonial'; 
        ...
        <tbody><tr>
          ...
          <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;">
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: sans-serif;color: #60666d;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;" src="http://sportyjuice.com/themes/sportyjuice/images/contact-bg.jpg" alt="" width="100%">
            </div>
...
<p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 24px;font-size: 15px;line-height: 24px;font-family: sans-serif;color: #60666d;">Seseorang yang bernama '.$contact_name.' telah menghubungi anda, berikut ini detail mengenai testimonial yang dikirim oleh saudara '.$contact_name.'.</p>
