    ...
    <?php 
            ...
            ?>
              <div class="carousel-item <?php echo ($i==1 ? 'active' : ''); ?>">
                <img class="img-fluid" src="<?php echo base_url('files/2021/'.($gallery->img_slideshow=="" ? 'no_thumbnail.jpg' : $gallery->img_slideshow)); ?>" alt="UNIVERSITAS AMIKOM PURWOKERTO" >
              </div>					
      ...
      <!--<div id="carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('assets/main/images/carousel/pmbgel2-2021.webp'); ?>" width="100%" >
          </div>
          <div class="carousel-item">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('files/2021/CarouselHomeB.webp'); ?>" width="100%" >
          </div>

          <div class="carousel-item">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('files/2021/CarouselHomeC.webp'); ?>" width="100%" >
          </div>

          <div class="carousel-item">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('files/2021/CarouselHomeD.webp'); ?>" width="100%" >
          </div>

          <div class="carousel-item">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('files/2021/CarouselHomeE.webp'); ?>" width="100%" >
          </div>
          <div class="carousel-item">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('files/2021/CarouselHomeF.webp'); ?>" width="100%" >
          </div>
          <div class="carousel-item">
            <img alt="UNIVERSITAS AMIKOM PURWOKERTO"  src="<?php echo base_url('files/2021/CarouselHomeG.webp'); ?>" width="100%" >
          </div>
