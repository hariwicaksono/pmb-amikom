...
$kulum=$this->mmenupmb->get_jadwal_PSU($this->data['tahun_pmb']) ;
	$h1 = array('data' => 'NO', 'class' => 'highlight', 'bgcolor' => '#663399');
  $h2 = array('data' => 'gelombang', 'class' => 'highlight', 'bgcolor' => '#663399');
  $h3 = array('data' => 'Angktn', 'class' => 'highlight', 'bgcolor' => '#663399','width'=>'5%');
  $h4 = array('data' => 'Hari', 'class' => 'highlight', 'bgcolor' => '#663399','width'=>'20%');
  $h5 = array('data' => 'Tanggal', 'class' => 'highlight', 'bgcolor' => '#663399','width'=>'35%');
  $h6 = array('data' => 'Jam', 'class' => 'highlight', 'bgcolor' => '#663399','width'=>'25%');
  $h7 = array('data' => 'Ruang', 'class' => 'highlight', 'bgcolor' => '#663399','width'=>'25%');
  $this->table->set_empty("&nbsp;");
  $this->table->set_heading($h1,$h2,$h3,$h4,$h5,$h6,$h7);
		$i = 0;
...
$i++;
 $cell1 = array('data' => $i, 'class' => 'highlight', 'bgcolor' => '#FF6600');
 $cell2 = array('data' => $row->gelombang, 'class' => 'highlight', 'bgcolor' => '#FF6600');
 $cell3= array('data' => anchor('pmb/list_angkatan_psu/'.$row->ID_JADWALPSU,$row->ANGKATAN_PSU), 'class' => 'highlight', 'bgcolor' => '#FF6600');
 $cell4 = array('data' =>  $this->hari($row->MULAI_PSU).' - '. $this->hari($row->END_PSU), 'class' => 'highlight', 'bgcolor' => '#FF6600');
 $cell5 = array('data' =>  date('d-m-Y',strtotime($row->MULAI_PSU)).' - '.date('d-m-Y',strtotime($row->END_PSU)), 'class' => 'highlight', 'bgcolor' => '#FF6600');
 $cell6 = array('data' =>  date('H:i',strtotime($row->MULAI_PSU)).'- '.date('H:i',strtotime($row->END_PSU)), 'class' => 'highlight', 'bgcolor' => '#FF6600');
 $cell7 = array('data' => $row->RUANG, 'class' => 'highlight', 'bgcolor' => '#FF6600');
$this->table->add_row($cell1,$cell2,$cell3,$cell4,$cell5,$cell6,$cell7);       
}
$this->data['content_title']='JADWAL PELATIHAN SUPER UNGGUL';
$this->data['isi_tupoksi']=$this->table->generate();
$this->data['modul']=$this->uri->segment(2);
$this->data['konten']='view_isi';
$this->load->view('view_main',$this->data);
...
function registrasi() {
  $this->data['konten']='view_registrasi';
 ...
 if (isset($_POST['nama'])) {
  ...
  $this->session->set_flashdata('info',"Proses daftar berhasil");
