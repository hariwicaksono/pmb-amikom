...
function lihatprofil($priv, $institusi, $status, $profil, $iduser){
    
    if($priv == "Edurace Users" and $_SESSION['iduser'] != null or $iduser == $_SESSION['iduser']){
        return $profil;
    }
    elseif($priv == "School" and $institusi == $_SESSION['INSTITUSI_ID'] or $iduser == $_SESSION['iduser']){
        return $profil;
    }
    elseif($priv == "Friends" and $status == "1" or $iduser == $_SESSION['iduser']){
        return $profil;
    }
