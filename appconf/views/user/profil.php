                        ...
                        <option value="">Pilih Status Pernikahan</option>
                            <?php
                                ...
                                foreach ($status_pernikahan as $status) { ?>
                                    <option value="<?=$status?>" <?php if (!empty($biodata)) { if ($biodata['status_pernikahan']==$status) { echo 'selected=selected'; }} ?> ><?=$status?></option>
                            <?php
                                $i++;
                                }
                            ?>
                        ...
                        <?php
                            ...
                            $info2=array('S','M','L','XL','XXL','3L','5L');
                                ...
                                foreach ($info2 as $key) { ?>
                                        ...
                                        <input type="radio" name="ukuran_jas" value="<?=$key?>" 
                                        <?php if (!empty($biodata)) { 
                        ...
                        <div class="col-md-3">
                            <select class="form-control form-control-lg" name="pekerjaan_ortu" >
                                ...
                                foreach ($pekerjaan1 as $kerja1) { ?>
                                            <option value="<?=$kerja1?>" <?php if (!empty($biodata)) { if ($biodata['PEKERJAAN_ORTU']==$kerja1) { echo 'selected=selected'; }} ?>><?=$kerja1?></option>
                                <?php   
                                }
                                    ?>
                            </select>
                        ...
                        <div class="col-md-3">
                            <select class="form-control form-control-lg" name="pekerjaan_ayah" >
                                ...
                                foreach ($pekerjaan2 as $kerja2) { ?>
                                            <option value="<?=$kerja2?>" <?php if (!empty($biodata)) { if ($biodata['PEKERJAAN_AYAH']==$kerja2) { echo 'selected=selected'; }} ?>><?=$kerja2?></option>
                                <?php   
                                }
                                    ?>
                            </select>
...
$jne3.ajax({
    ...
    data:{pilihan3:pilihan3,jenis_mhs:jenis_mhs},
    cache:false,
    success: function(returndata){
...
var $jquery=jQuery.noConflict();
      $jquery(document).ready(function(){
        ...
        $jquery("#form").validate({
            ...
            telp_ayah : {required : true, number : true, minlength : 6},
            pekerjaan_ortu : { required : true },
            pekerjaan_ayah : { required : true },
            status_reg : {required : true},
            jenis_mhs : {required : true},
            relasi : { required : true},
            kelas : { required : true },
            ukuran_jas : { required : true },
            'info[]' : {required : true},
            },
            messages:{ 
            nama: {
